 ...
 * <td>A parallel group positions its child elements in the same space on top of each other.
 ...
 * axis independently. That is, there is a group representing the horizontal axis, and a separate
 * group representing the vertical axis. The horizontal group is responsible for setting the x and
 * width of its contents, where as the vertical group is responsible for setting the y and height of
 * its contents.
 * <p>
 ...
 * <ul>
 * <li>The horizontal axis consists of a sequential group containing two parallel groups. The first
 * parallel group consists of the labels, with the second parallel group consisting of the text
 * fields.
 * <li>The vertical axis similarly consists of a sequential group containing two parallel groups.
 * The parallel groups align their contents along the baseline. The first parallel group consists of
 * the first label and text field, and the second group consists of the second label and text field.
 * </ul>
 * There are a couple of things to notice in this code:
 * <ul>
 * <li>You need not explicitly add the components to the container, this is indirectly done by using
 * one of the <code>add</code> methods.
 * <li>The various <code>add</code> methods of <code>Groups</code> return themselves. This allows
 * for easy chaining of invocations. For example, <code>group.add(label1).add(label2);</code> is
 * equivalent to <code>group.add(label1);group.add(label2);</code>.
 * <li>There are no public constructors for the Groups, instead use the create methods of
 * <code>GroupLayout</code>.
 * </ul>
 * GroupLayout offer the ability to automatically insert the appropriate gap between components.
 * This can be turned on using the <code>setAutocreateGaps()</code> method. Similarly you can use
 * the <code>setAutocreateContainerGaps()</code> method to insert gaps between the components and
 * the container.
 * 
...
public class GroupLayout extends Layout {
  ...
  /**
   * Possible argument when linking sizes of components. Specifies the the two component should
   * share the same size along the horizontal axis.
   * 
  ...
  /**
   * Possible argument when linking sizes of components. Specifies the the two component should
   * share the same size along the vertical axis.
   * 
   * @see #linkSize(java.awt.Component[],int)
   */
  ...
  /**
   * Possible alignment type. Indicates the elements should be aligned to the origin. For the
   * horizontal axis with a left to right orientation this means aligned to the left.
   * 
  ...
  /**
   * Possible value for the add methods that takes a Component. Indicates the size from the
   * component should be used.
   */
  public static final int DEFAULT_SIZE = -1;
  /**
   * Possible value for the add methods that takes a Component. Indicates the preferred size should
   * be used.
   */
  ...
  /**
   * Group responsible for layout along the horizontal axis. This is NOT the user specified group,
   * use getHorizontalGroup to dig that out.
   */
  private Group horizontalGroup;
  /**
   * Group responsible for layout along the vertical axis. This is NOT the user specified group, use
   * getVerticalGroup to dig that out.
   */
  private Group verticalGroup;
  // Maps from Component to ComponentInfo.  This is used for tracking
  // information specific to a Component.
  private final Map<Control, ComponentInfo> componentInfos;
  ...
  private final Set<Spring> tmpParallelSet;
  ...
  public GroupLayout(Composite host) {
    ...
    componentInfos = new HashMap<Control, ComponentInfo>();
    tmpParallelSet = new HashSet<Spring>();
  }

  /**
   * Sets whether component visiblity is considered when sizing and positioning components. A value
   * of <code>true</code> indicates that non-visible components should not be treated as part of the
   * layout. A value of <code>false</code> indicates that components should be positioned and sized
   * regardless of visibility.
   * <p>
   * A value of <code>false</code> is useful when the visibility of components is dynamically
   ...
   * <code>Boolean.TRUE</code> indicates that if <code>component</code> is not visible it should not
   * be treated as part of the layout. A value of <code>false</code> indicates that
   * <code>component</code> is positioned and sized regardless of it's visibility. A value of
   * <code>null</code> indicates the value specified by the single argument method <code>
   * setHonorsVisibility</code> should be used.
   * <p>
   * If <code>component</code> is not a child of the <code>Container</code> this
   * <code>GroupLayout</code> is managing, it will be added to the <code>Container</code>.
   * 
   * @param component
   *          the component
   * @param honorsVisibility
   *          whether <code>component</code>'s visiblity should be considered for sizing and
   *          positioning
   * @throws IllegalArgumentException
  ...
  /**
   * Returns a textual description of this GroupLayout. The return value is intended for debugging
   * purposes only.
   * 
  ...
  private void dump(StringBuffer buffer, Spring spring, String indent, int axis) {
    ...
    if (spring instanceof AutopaddingSpring) {
      ...
      padding =
          ", userCreated="
              + paddingSpring.getUserCreated()
              + ", matches="
              + paddingSpring.getMatchDescription();
    }
    buffer.append(indent
        + spring.getClass().getName()
        + " "
    ...
    if (spring instanceof Group) {
      ...
      for (int counter = 0; counter < springs.size(); counter++) {
        dump(buffer, springs.get(counter), indent, axis);
      }
    }
  }

  /**
   * Sets whether or not a gap between components should automatically be created. For example, if
   * this is true and you add two components to a <code>SequentialGroup</code> a gap between the two
   * will automatically be created. The default is false.
   * 
   ...
   * 
   * @param autocreatePadding
   *          whether or not to automatically create gaps between the container and first/last
   *          components.
   */
   ...
   * automatically be created. The default is false.
   * 
   * @return whether or not the gaps between the container and the first/last components should
  ...
  /**
   * Wraps the user specified group in a sequential group. If container gaps should be generate the
   * necessary springs are added.
   */
  ...
  /**
   * Creates and returns a <code>ParallelGroup</code> with a <code>LEADING</code> alignment. This is
   * a cover method for the more general <code>createParallelGroup(int)</code> method.
   * 
  ...
  /**
   * Creates and returns an <code>ParallelGroup</code>. The alignment specifies how children
   * elements should be positioned when the the parallel group is given more space than necessary.
   * For example, if a ParallelGroup with an alignment of TRAILING is given 100 pixels and a child
   * only needs 50 pixels, the child will be positioned at the position 50.
   * 
   * @param alignment
   *          alignment for the elements of the Group, one of <code>LEADING</code>,
   *          <code>TRAILING</code>, <code>CENTER</code> or <code>BASELINE</code>.
   * @throws IllegalArgumentException
   *           if alignment is not one of <code>LEADING</code>, <code>TRAILING</code>,
   ...
   *          <code>TRAILING</code>, <code>CENTER</code> or <code>BASELINE</code>.
   * @param resizable
   *          whether or not the group is resizable. If the group is not resizable the min/max size
   *          will be the same as the preferred.
   * @throws IllegalArgumentException
   *           if alignment is not one of <code>LEADING</code>, <code>TRAILING</code>,
   *           <code>CENTER</code> or <code>BASELINE</code>
   * @return a new <code>ParallelGroup</code>
  ...
  /**
   * Forces the set of components to have the same size. This can be used multiple times to force
   ...
   */
  public void linkSize(Control[] components) {
  ...
  private void linkSize0(Control[] components, int axis) {
   ...
   * @throws IllegalArgumentException
   *           is either of the Components are null or if existingComponent is not being managed by
   *           this layout manager
   */
  /*public void replace(Control existingComponent, Control newComponent) {
  ...
  /**
   * Sets the LayoutStyle this GroupLayout is to use. A value of null can be used to indicate the
  ...
  //    }
  /**
   * Notification that a <code>Component</code> has been removed from the parent container. You
   * should not invoke this method directly, instead invoke <code>remove</code> on the parent
   * <code>Container</code>.
   * 
   * @param component
   ...
   */
  public void removeLayoutComponent(Control component) {
   ...
   * @throws IllegalArgumentException
   *           if <code>parent</code> is not the same <code>Container</code> that this was created
   *           with
   * @throws IllegalStateException
   *           if any of the components added to this layout are not in both a horizontal and
   *           vertical group
  ...
  protected Point computeSize(Composite parent, int wHint, int hHint, boolean flushCache) {
    ...
    prepare(PREF_SIZE);
    return adjustSize(
        horizontalGroup.getPreferredSize(HORIZONTAL),
...
/*    public Dimension minimumLayoutSize(Container parent) {
  ...
  protected void layout(Composite parent, boolean flushCache) {
    ...
    int[] insets = Baseline.getInsets(parent);
    Rectangle parentBounds = parent.getBounds();
    int width = parentBounds.width - insets[0] - insets[2];
    int height = parentBounds.height - insets[1] - insets[3];
    ...
    Iterator<ComponentInfo> componentInfo = componentInfos.values().iterator();
    Rectangle clientArea = parent.getClientArea();
    while (componentInfo.hasNext()) {
      ComponentInfo info = componentInfo.next();
      info.setBounds(clientArea.x, clientArea.y, parent.getSize().x, ltr);
    }
  }
...
/*    public Dimension maximumLayoutSize(Container parent) {
   ...
   *           with
   */
/*    public void invalidateLayout(Composite parent) {
        checkParent(parent);
  ...
  private void prepare(int sizeType) {
    ...
    if (!isValid) {
      ...
      for (Iterator<ComponentInfo> cis = componentInfos.values().iterator(); cis.hasNext();) {
        ComponentInfo ci = cis.next();
  ...
  private Point adjustSize(int width, int height) {
    int[] insets = Baseline.getInsets(host);
    return new Point(width + insets[0] + insets[2], height + insets[1] + insets[3]);
  }
   ...
   */
  private ComponentInfo getComponentInfo(Control component) {
  ...
  /**
   * Adjusts the autopadding springs for the horizontal and vertical groups. If <code>insert</code>
   * is true this will insert auto padding springs, otherwise this will only adjust the springs that
   * comprise auto preferred padding springs.
   */
  private void insertAutopadding(boolean insert) {
    horizontalGroup.insertAutopadding(
        HORIZONTAL,
        new ArrayList<Spring>(1),
        new ArrayList<Spring>(1),
        new ArrayList<Spring>(1),
        new ArrayList<Spring>(1),
        insert);
    verticalGroup.insertAutopadding(
        VERTICAL,
        new ArrayList<Spring>(1),
        new ArrayList<Spring>(1),
        new ArrayList<Spring>(1),
  ...
  /**
   * Returns true if the two Components have a common ParallelGroup ancestor along the particular
   * axis.
   */
  private boolean areParallelSiblings(Control source, Control target, int axis) {
  ...
  private boolean isLeftToRight() {
    return (host.getStyle() & SWT.LEFT_TO_RIGHT) != 0;
  }

  /**
   * Spring consists of a range: min, pref and max a value some where in the middle of that and a
   * location. Subclasses must override methods to get the min/max/pref and will likely want to
   * override the <code>setSize</code> method. Spring automatically caches the min/max/pref. If the
   * min/pref/max has internally changes, or needs to be updated you must invoked clear.
   */
  abstract class Spring {
    ...
    /**
     * Sets the value and location of the spring. Subclasses will want to invoke super, then do any
     * additional sizing.
     * 
     * @param axis
   ...
   * <code>GroupLayout</code>: laying out components one after another (<code>SequentialGroup</code>
   * ) or layout on top of each other (<code>ParallelGroup</code>). Use one of
   * <code>createSequentialGroup</code> or <code>createParallelGroup</code> to create one.
   */
  public abstract class Group extends Spring {
    ...
    /**
     * Used to compute how the two values representing two springs will be combined. For example, a
     * group that layed things out one after the next would return <code>a + b</code>.
     */
    ...
    // Padding
    /**
     * Adjusts the autopadding springs in this group and its children. If <code>insert</code> is
     * true this will insert auto padding springs, otherwise this will only adjust the springs that
     * comprise auto preferred padding springs.
     * 
     * @param axis
     ...
     * @param insert
     *          Whether or not to insert AutopaddingSprings or just adjust any existing
     *          AutopaddingSprings.
     */
    abstract void insertAutopadding(int axis,
        List<Spring> leadingPadding,
        List<Spring> trailingPadding,
        List<Spring> leading,
        List<Spring> trailing,
        boolean insert);
  ...
  /**
   * A <code>Group</code> that lays out its elements sequentially, one after another. This class has
   * no public constructor, use the <code>createSequentialGroup</code> method to create one.
   * 
  ...
  public class SequentialGroup extends Group {
     ...
     * @param useAsBaseline
     *          whether the specified <code>Group</code> should be used to calculate the baseline
     *          for this <code>Group</code>
    ...
    /**
     * Adds the specified Component. If the Component's min/max are different from its pref than the
     * component will be resizable.
     * 
     * @param component
     *          the Component to add
     * @return this <code>SequentialGroup</code>
     */
    public SequentialGroup add(Control component) {
     ...
     * 
     * @param useAsBaseline
     *          whether the specified <code>Component</code> should be used to calculate the
     *          baseline for this <code>Group</code>
     * @param component
     *          the <code>Component</code> to add
     * @return this <code>Group</code>
     */
    public SequentialGroup add(boolean useAsBaseline, Control component) {
      add(component);
      if (useAsBaseline) {
    ...
    /**
     * Adds the specified <code>Component</code>. Min, pref and max can be absolute values, or they
     * can be one of <code>DEFAULT_SIZE</code> or <code>PREFERRED_SIZE</code>. For example, the
     * following:
     * 
     * <pre>
     ...
     * @return this <code>SequentialGroup</code>
     */
    public SequentialGroup add(Control component, int min, int pref, int max) {
     ...
     * @return this <code>Group</code>
     */
    public SequentialGroup add(boolean useAsBaseline, Control component, int min, int pref, int max) {
     ...
     * @see LayoutStyle
     */
    public SequentialGroup addPreferredGap(Control comp1, Control comp2, int type) {
     ...
     * @see LayoutStyle
     */
    public SequentialGroup addPreferredGap(Control comp1, Control comp2, int type, boolean canGrow) {
    ...
    /**
     * Adds an element representing the preferred gap between the nearest components. That is,
     * during layout the neighboring components are found, and the min, pref and max of this element
     * is set based on the preferred gap between the components. If no neighboring components are
     * found the min, pref and max are set to 0.
     * 
     * @param type
    ...
    /**
     * Adds an element for the preferred gap between the nearest components. That is, during layout
     * the neighboring components are found, and the min of this element is set based on the
     * preferred gap between the components. If no neighboring components are found the min is set
     * to 0. This method allows you to specify the preferred and maximum size by way of the
     * <code>pref</code> and <code>max</code> arguments. These can either be a value &gt;= 0, in
     * which case the preferred or max is the max of the argument and the preferred gap, of
     ...
     * @throws IllegalArgumentException
     *           if type is not one of <code>LayoutStyle.RELATED</code> or
     *           <code>LayoutStyle.UNRELATED</code> or pref/max is != DEFAULT_SIZE and < 0, or pref
     *           > max
     * @see LayoutStyle
     */
    ...
    /**
     * Adds an element representing the preferred gap between one edge of the container and the
     * next/previous Component. This will have no effect if the next/previous element is not a
    ...
    void insertAutopadding(int axis,
        ...
        List<Spring> trailing,
        boolean insert) {
      List<Spring> newLeadingPadding = new ArrayList<Spring>(leadingPadding);
      ...
      for (int counter = 0; counter < springs.size(); counter++) {
        ...
        if (spring instanceof AutopaddingSpring) {
          ...
          if (spring instanceof ComponentSpring) {
            ...
            ((Group) spring).insertAutopadding(
                axis,
                newLeadingPadding,
                newTrailingPadding,
                newLeading,
  ...
  /**
   * A <code>Group</code> that lays out its elements on top of each other. If a child element is
   * smaller than the provided space it is aligned based on the alignment of the child (if
   * specified) or on the alignment of the ParallelGroup.
   * 
  ...
  public class ParallelGroup extends Group {
     ...
     */
    public ParallelGroup add(Control component) {
      return add(component, DEFAULT_SIZE, DEFAULT_SIZE, DEFAULT_SIZE);
    }
     ...
     * @return this <code>SequentialGroup</code>
     */
    public ParallelGroup add(Control component, int min, int pref, int max) {
     ...
     * @return this <code>ParallelGroup</code>
     * @throws IllegalArgumentException
     *           if alignment is not one of <code>LEADING</code>, <code>TRAILING</code> or
     *           <code>CENTER</code>
     */
     ...
     *           <code>CENTER</code>
     */
    public ParallelGroup add(int alignment, Control component) {
     ...
     * @return this <code>Group</code>
     */
    public ParallelGroup add(int alignment, Control component, int min, int pref, int max) {
      checkChildAlignment(alignment);
    ...
    void setChildSize(Spring spring, int axis, int origin, int size) {
      ...
      int springSize =
          Math.min(Math.max(spring.getMinimumSize(axis), size), spring.getMaximumSize(axis));
  ...
  /**
   * An extension of <code>ParallelGroup</code> that aligns its constituent <code>Spring</code>s
   * along the baseline.
   */
        ...
        if (alignment == NO_ALIGNMENT || alignment == BASELINE) {
          ...
          if (baseline >= 0) {
            ...
            switch (spring.getBaselineResizeBehavior()) {
              ...
              case Baseline.BRB_CONSTANT_DESCENT :
                height =
                    Math.min(ascent, springMax - springPref + baseline) + springPref - baseline;
   ...
   * <li>Force the min/max/pref to be a certain value. If the Component's size is to be linked to
   * another components than the min/max/pref all come from the ComponentInfo.
   */
  private final class ComponentSpring extends Spring {
    ...
    // SWT: we cant determine min/max sizes for component so all 
    // of sizes are preferred
    @Override
    int calculateMinimumSize(int axis) {
      if (isLinked(axis)) {
    ...
    int calculateNonlinkedMinimumSize(int axis) {
      ...
      if (min != DEFAULT_SIZE) {
        throw new IllegalArgumentException("min != DEFAULT_SIZE");
      }
      int size = getSizeAlongAxis(axis, component.computeSize(SWT.DEFAULT, SWT.DEFAULT, true));
      // should not be more than explicitly defined preferred size
      return pref >= 0 ? Math.min(size, pref) : size;
    ...
    int calculateNonlinkedPreferredSize(int axis) {
      ...
      if (pref != DEFAULT_SIZE && pref != PREFERRED_SIZE) {
        throw new IllegalArgumentException("pref != DEFAULT_SIZE && pref != PREFERRED_SIZE");
      }
      return getSizeAlongAxis(axis, component.computeSize(SWT.DEFAULT, SWT.DEFAULT, true));
    ...
    int calculateNonlinkedMaximumSize(int axis) {
      ...
      if (max != DEFAULT_SIZE) {
        throw new IllegalArgumentException("max != DEFAULT_SIZE");
      }
      return getSizeAlongAxis(axis, component.computeSize(SWT.DEFAULT, SWT.DEFAULT, true));
      // return getSizeAlongAxis(axis, component.getMaximumSize());
    }

    private int getSizeAlongAxis(int axis, Point size) {
    ...
    int getBaseline() {
      if (baseline == -1 /*&& (component instanceof JComponent)*/) {
        ...
        if (width > 0 && height > 0) {
          baseline = Baseline.getBaseline(component, width, getPreferredSize(VERTICAL));
        }
      }
      return baseline;
    }
  ...
  private final class PaddingSpring extends Spring {
    ...
    PaddingSpring(Control source, Control target, int type, boolean canGrow) {
      this.source = source;
      this.target = target;
      this.type = type;
    ...
    private int getPadding(int axis) {
      ...
      return getLayoutStyle0().getPreferredGap(
          source.getClass(),
          source.getStyle(),
          target.getClass(),
          target.getStyle(),
  ...
  /**
   * Spring reprensenting the distance between any number of sources and targets. The targets and
   * sources are computed during layout. An instance of this can either be dynamically created when
  ...
  private class AutopaddingSpring extends Spring {
    ...
    public void calculatePadding(int axis) {
      ...
      if (matches != null) {
        ...
        for (int i = matches.size() - 1; i >= 0; i--) {
          AutopaddingMatch match = matches.get(i);
          maxPadding =
              Math.max(maxPadding, calculatePadding(p, position, match.source, match.target));
        }
      }
      if (size == UNSET) {
        size = 0;
    ...
    private int calculatePadding(LayoutStyle p,
        int position,
        ComponentSpring source,
        ComponentSpring target) {
      int delta = target.getOrigin() - (source.getOrigin() + source.getSize());
      if (delta >= 0) {
        Control sourceControl = source.getComponent();
        Control targetControl = target.getComponent();
        int padding =
            p.getPreferredGap(
                sourceControl.getClass(),
                sourceControl.getStyle(),
                targetControl.getClass(),
                targetControl.getStyle(),
                type,
                position);
        if (padding > delta) {
    ...
    public void addTarget(ComponentSpring spring, int axis) {
      ...
      if (source != null) {
        ...
        Control component = spring.getComponent();
  ...
  private class ContainerAutopaddingSpring extends AutopaddingSpring {
    ...
    public void calculatePadding(int axis) {
      ...
      if (targets != null) {
        ...
        for (int i = targets.size() - 1; i >= 0; i--) {
          ...
          int padding = 10;
          Control control = targetSpring.getComponent();
          padding = p.getContainerGap(control.getClass(), control.getStyle(), position);
    ...
    private int updateSize(LayoutStyle p, ComponentSpring sourceSpring, int position) {
      Control control = sourceSpring.getComponent();
      int padding = p.getContainerGap(control.getClass(), control.getStyle(), position);
      //            int padding = 10;
      ...
      //            }
      int delta =
          Math.max(0, getParent().getSize() - sourceSpring.getSize() - sourceSpring.getOrigin());
      size = Math.max(size, padding - delta);
      return padding;
    }
    ...
    public void add(ComponentInfo child) {
      ...
      if (childMaster == null) {
        ...
        for (int i = 0; i < childMaster.linked.size(); i++) {
          ComponentInfo childInfo = childMaster.linked.get(i);
    ...
    private int calculateLinkedSize(int axis) {
      ...
      for (int i = 0; i < linked.size(); i++) {
        ...
        if (axis == HORIZONTAL) {
          ...
          if (axis != VERTICAL) {
            throw new IllegalArgumentException("axis != VERTICAL");
          }
  ...
  /**
   * Tracks the horizontal/vertical Springs for a Component. This class is also used to handle
   * Springs that have their sizes linked.
   */
  private final class ComponentInfo {
    ...
    ComponentInfo(Control component) {
      this.component = component;
      updateVisibility();
    }
    ...
    boolean updateVisibility() {
      ...
      if (this.honorsVisibility == null) {
        honorsVisibility = getHonorsVisibility();
      } else {
    ...
    public void setBounds(int offsetLeft, int offsetTop, int parentWidth, boolean ltr) {
      int x = 0;
      int y = 0;
      int w = 0;
      int h = 0;
      ...
      component.setBounds(x + offsetLeft, y + offsetTop, w, h);
    }
